...
namespace mt {
	...
	public:
		Blank();
		Blank(const std::string& name_, const std::string& surname_, const std::vector<std::string>& dolgs);
		...
		void set_dolgs(const std::vector<std::string>& dolgs);
		void add_dolg(const std::string& dolg);

		//ГЕТТЕРЫ-------------------------------------------------------------------------------------
		std::string get_name() const;
		std::string get_surname() const;
		std::vector<std::string> get_dolgs() const;
